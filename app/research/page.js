export default function Research() {
  return (
    <div style={{ 
      ...
      <h1 style={{ fontSize: '2.5rem', marginBottom: '20px' }}>Research Experience</h1>

      {/* Glacier Change Analysis Project */}
      <div style={{ marginBottom: '30px' }}>
        <h2 style={{ fontSize: '1.5rem', margin: '0', padding: '0' }}>
          Glacier Change Analysis Using Satellite Imagery
        </h2>
        <h3 style={{ fontSize: '1.2rem', margin: '0', padding: '0', color: '#555' }}>
          Department of Geosciences, Mississippi State University
        </h3>
        <p style={{ fontSize: '1rem', margin: '0', padding: '0', fontStyle: 'italic' }}>
